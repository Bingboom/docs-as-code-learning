     ...
     -
       .. list-table::
          ...
          * - Key
            - Value
          * - "GSM"
            - GSM默认字母表（GSM03.38.6.2.1）
          * - "IRA"
            - 国际参考字母表(international reference alphabet)(ITU-T T.50)
          * - "UCS2"
            - 16-bit universal multiple-octet coded character set (USO/IEC10646)。UCS2字符串被转换成一个十六进制数（0x0000～0xFFFF）
          * - "PCCP936"
            - 等同GBK编码格式
          * - "UTF-8"
